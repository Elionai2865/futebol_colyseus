...
import { FootballRoomState, FootballNetworkedEntity, FootballNetworkedUser } from "./schema/FootballRoomState";
const logger = require("../helpers/logger");

export class FootballRoom extends Room<FootballRoomState> {
    ...
    async onCreate(options: any) {
        ...
        // Set state schema
        //
        this.setState(new FootballRoomState());
        ...
        this.onMessage("createEntity", (client: Client, creationMessage: any) => {
            ...
            let newEntity = new FootballNetworkedEntity().assign({
                id: entityViewID,
    ...
    onJoin(client: Client, options: any) {
        ...
        let newNetworkedUser = new FootballNetworkedUser().assign({
