...
public class ShootAI : Shoot
{
	...
	public BallView viewOfTheBall;
	public TalkingToPlayer talkingToMyPlayer;
	...
	protected override void Update ()
	{
		...
		else
		{
			...
			{
				if (viewOfTheBall.HasInit && viewOfTheBall.IsMine && talkingToMyPlayer.myTurn)
				{
					base.Update();
				}
			}
			...
			{
				yPosition = Mathf.Clamp(gameObject.transform.localPosition.y, 0.34f, 1000.0f);
